...
// Main App component
const App = () => {
  const canvasRef = useRef(null); // Re-introducing canvasRef
  ...
  // Canvas animation logic (re-introduced)
  ...
  return (
    <div className="min-h-screen font-inter text-gray-100 relative overflow-hidden bg-gray-900"> {/* Added bg-gray-900 for a base dark background */}
      {/* Canvas for background animation */}
      <canvas ref={canvasRef} className="absolute inset-0 z-0"></canvas>

      {/* Main content container with gradient overlay */}
      <div className="relative z-10 p-4 sm:p-8 md:p-12 lg:p-16 bg-gradient-to-br from-transparent via-purple-900/20 to-blue-900/20 min-h-screen"> {/* Adjusted gradient for subtle overlay */}
        {/* Header Section */}
